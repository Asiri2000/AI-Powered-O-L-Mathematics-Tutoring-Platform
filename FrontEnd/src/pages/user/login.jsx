    ...
    <div className="min-h-screen flex items-center justify-center bg-white p-4 relative overflow-hidden">
      ...
      <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl w-full max-w-md p-8 md:p-10 border border-white/20 relative z-10 animate-fadeIn">
        ...
        <div className="text-center mb-8">
             ...
             {redirectMessage && (
            <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-800 flex items-center gap-3 text-left">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-center text-sm text-gray-500">
          <p className="flex items-center justify-center gap-2">
            ...
            © 2026 Mathematics Tutoring Platform. All rights reserved.
          </p>
        </div>
